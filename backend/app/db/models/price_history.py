...
class PriceHistory(SQLModel, table=True):
    ...
    __table_args__ = (
        UniqueConstraint("security_id", "trade_date", name="uq_price_history_security_id_trade_date"),
        Index("ix_price_history_security_id_trade_date", "security_id", "trade_date"),
    )
